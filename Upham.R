...
#start plotting
pdf(file="Upham_et_al_2020.SIMMAP-V1.pdf", width=10, height=10)
...
write.table(pd.1$ace, file='Upham_et_al_2020.posteriorprobability.SIMMAP.V1.txt', quote=F, sep="\t", row.names=T, col.names=T)
...
pdf(file="Upham_et_al_2020.SIMMAP.pd-V1.pdf", width=10, height=10)
plot(dd)
dev.off()


#start plotting
pdf(file="Upham_et_al_2020.SIMMAP.ARD-V1.pdf", width=10, height=10)
#change to your output directory
...
write.table(pd.ARD.1$ace, file='Upham_et_al_2020.posteriorprobability.SIMMAP.ARD.V1.txt', quote=F, sep="\t", row.names=T, col.names=T)
...
pdf(file="Upham_et_al_2020.SIMMAP.pd.ARD-V1.pdf", width=10, height=10)
plot(dd)
dev.off()
...
#start plotting
pdf(file="Upham_et_al_2020.SIMMAP-V2.pdf", width=10, height=10)
#change to your output directory
...
write.table(pd.2$ace, file='Upham_et_al_2020.posteriorprobability.SIMMAP.V2.txt', quote=F, sep="\t", row.names=T, col.names=T)
...
pdf(file="Upham_et_al_2020.SIMMAP.pd-V2.pdf", width=10, height=10)
plot(dd)
dev.off()


#start plotting
pdf(file="Upham_et_al_2020.SIMMAP.ARD-V2.pdf", width=10, height=10)
#change to your output directory
...
write.table(pd.ARD.2$ace, file='Upham_et_al_2020.posteriorprobability.SIMMAP.ARD.V2.txt', quote=F, sep="\t", row.names=T, col.names=T)
...
pdf(file="Upham_et_al_2020.SIMMAP.pd.ARD-V2.pdf", width=10, height=10)
plot(dd)
dev.off()


#start plotting parsimony reconstruction
pdf(file="Upham_et_al_2020.MPR-V2.pdf", width=10, height=10)
#change to your output directory
...
write.table(pars, file='Upham_et_al_2020.parsimony.V2.txt', quote=F, sep="\t", row.names=T, col.names=T)
